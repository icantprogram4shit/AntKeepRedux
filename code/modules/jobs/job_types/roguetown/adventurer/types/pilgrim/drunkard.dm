/datum/advclass/drunkard
	name = "Gambler"
	tutorial = "You are a gambler. Everyone in your life has given up on you, and the stress of losing it all over and over has taken its toll on your body. All you have left to your name are some cards, dice and whatever is in this bottle. At least you're probably still in Saint Bakkus' good graces, whether you reciprocate such feelings or not..."
...
/datum/outfit/job/roguetown/adventurer/drunkard/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		if(H.patron.type == /datum/patron/psydon_heresy/fredonian)
