/datum/advclass/minstrel
	name = "Minstrel"
	tutorial = "You are a musician at heart, and not like those so-called troubadours who traipse around in fancy cloth and swordfight in the woods. Music is truly your calling, you're just... Yet to find a receptive audience."
